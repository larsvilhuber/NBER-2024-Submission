...
qpdf --pages "$NBER_PDF" 1-${NBER_BEFORE_PAGE} -- "$NBER_PDF" "NBER_2024_Vilhuber-submitted-20250410-no-responses.pdf"

echo "Extracting Responses section from $NBER_PDF (pages ${NBER_RESPONSES_PAGE}-z)..."
qpdf --pages "$NBER_PDF" ${NBER_RESPONSES_PAGE}-z -- "$NBER_PDF" "NBER_2024_Vilhuber-submitted-20250410-responses.pdf"
