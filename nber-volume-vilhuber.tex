...
In \citet{vilhuber2025e}, I demonstrate a simple scenario that satisfies most of the desiderata,  using containers. 
%
...
While containers are not the ``normal'' way of developing statistical models in economics, they are increasingly being used in statistics, and at the cutting edge of the social sciences. \citet{boettiger_introduction_2015} described the context of containers more  than 10 years ago, and the R community-maintained containers\footnote{\url{https://hub.docker.com/r/rocker/}} have more than 1 million downloads as of 2026. In the particular context described in this article, the system described by \citet{guimaraes_reproducibility_2023} has been actively using containers for several years, with mostly economists as  prime clientele. Tutorials and graduate education have emerged in the past 5 years, if not longer, that teach the next generation of economists the necessary tools.\footnote{See the excellent syllabus by \citet{mcdermott2021}, but also tutorials at the Carpentries \citep{eyers_reproducible_2020} and the Turing Way \citep{the_turing_way_community_containers_2024}.} In my own work as Data Editor for the \ac{AEA}, I have often successfully delegated to  undergraduates the task of figuring this out for themselves, and then teaching it to others, more senior \citep{graham2025}.
